...
public class MeshData {
	...
	Vector3[] borderVertices; //vertices that wont be included in mesh
	int[] borderTriangles;
	...
	public MeshData(int verticesPerLine, bool useFlatShading) {
		...
		borderTriangles = new int[24 * verticesPerLine]; // 4 * number of vertices per line in the mesh
	}
	...
	public void ProcessMesh(){
		if (useFlatShading) {
			FlatShading (); // BakeNormals not needed, edges not shared when using flatshading
		} else {
			BakeNormals ();	
		}
	}
